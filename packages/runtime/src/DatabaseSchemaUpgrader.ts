...
import { ConsumptionController, LocalAttribute, LocalRequest } from "@vermascht/consumption";
import { AccountController, DatawalletModification, DatawalletModificationCategory, DatawalletModificationType, TransportIds } from "@vermascht/transport";
