...
import { ICompleteOutgoingRequestParameters, OutgoingRequestsController } from "@vermascht/consumption";
import { Response, ResponseJSON } from "@vermascht/content";
import { CoreId, Message, MessageController } from "@vermascht/transport";
