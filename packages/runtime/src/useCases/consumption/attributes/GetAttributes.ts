...
import { AttributesController, LocalAttribute, LocalAttributeShareInfoJSON } from "@vermascht/consumption";
import { AbstractAttributeJSON, IdentityAttribute, IdentityAttributeJSON, RelationshipAttributeJSON } from "@vermascht/content";
