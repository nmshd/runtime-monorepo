...
export const CanCreateOutgoingRequestRequest: any = {
    ...
    definitions: {
                ...
                content: {
                    ...
                    properties: {
                        expiresAt: {
                            type: "string",
                            description:
                                "The point in time the request is considered obsolete either technically (e.g. the request is no longer valid or its response is no longer accepted) or from a business perspective (e.g. the request is no longer of interest).",
                        ...
                        items: {
                            ...
                            description:
                                "The items of the Request. Can be either a single  {@link  RequestItemJSONDerivations RequestItem }  or a  {@link  RequestItemGroupJSON RequestItemGroup } , which itself can contain further  {@link  RequestItemJSONDerivations RequestItems } ."
                        },
                        title: {
                            type: "string",
                        ...
                        metadata: {
                            type: "object",
                            description:
                                "This property can be used to add some arbitrary metadata to this request. The content of this property will be copied into the response on the side of the recipient."
                        },
                        "@context": {
                            type: "string"
                        }
        ...
        RequestItemGroupJSON: {
            ...
            properties: {
                ...
                mustBeAccepted: {
                    type: "boolean",
                    description:
                        "If set to `true`, the recipient has to accept this group if he wants to accept the Request. If set to `false`, the recipient can decide whether he wants to accept it or not."
                },
                metadata: {
                    type: "object",
                    description:
                        "This property can be used to add some arbitrary metadata to this group. The content of this property will be copied into the response on the side of the recipient, so the sender can use it to identify the group content as they receive the response."
                },
                items: {
                    type: "array",
                    items: {
        ...
        RequestItemJSON: {
            ...
            properties: {
                ...
                metadata: {
                    type: "object",
                    description:
                        "This property can be used to add some arbitrary metadata to this item. The content of this property will be copied into the response on the side of the recipient, so the sender can use it to identify the group content as they receive the response."
                },
                mustBeAccepted: {
                    type: "boolean",
                    description:
                ...
                requireManualDecision: {
                    type: "boolean",
                    description:
                        "If set to `true`, it advices the recipient of this RequestItem to carefully consider their decision and especially do not decide based on some automation rules."
                }
            },
            required: ["@type", "mustBeAccepted"],
            additionalProperties: false
        },
        ...
        RelationshipAttributeJSON: {
            ...
            required: ["@type", "confidentiality", "key", "owner", "value"],
            additionalProperties: false
        },
        ...
        PersonNameJSON: {
            ...
            required: ["@type", "givenName", "surname"],
            additionalProperties: false
        },
        PhoneNumberJSON: {
            type: "object",
        ...
        PostOfficeBoxAddressJSON: {
            ...
            required: ["@type", "boxId", "city", "country", "recipient", "zipCode"],
            additionalProperties: false
        },
        PseudonymJSON: {
            type: "object",
        ...
        StreetAddressJSON: {
            ...
            required: ["@type", "city", "country", "houseNo", "recipient", "street", "zipCode"],
            additionalProperties: false
        },
        WebsiteJSON: {
            type: "object",
        ...
        ShareAttributeRequestItemJSON: {
            ...
            required: ["@type", "attribute", "mustBeAccepted", "sourceAttributeId"],
            additionalProperties: false
        },
        ProposeAttributeRequestItemJSON: {
            ...
            required: ["@type", "attribute", "mustBeAccepted", "query"],
            additionalProperties: false
        },
        ...
        RelationshipAttributeQueryJSON: {
            ...
            required: ["@type", "attributeCreationHints", "key", "owner"],
            additionalProperties: false
        },
        RelationshipAttributeCreationHintsJSON: {
            ...
            required: ["title", "valueType", "confidentiality"],
            additionalProperties: false
        },
        ...
        ReadAttributeRequestItemJSON: {
            ...
            required: ["@type", "mustBeAccepted", "query"],
            additionalProperties: false
        },
        ThirdPartyRelationshipAttributeQueryJSON: {
            ...
            required: ["@type", "key", "owner", "thirdParty"],
            additionalProperties: false
        },
        ConsentRequestItemJSON: {
            ...
            required: ["@type", "consent", "mustBeAccepted"],
            additionalProperties: false
        },
        ...
        FreeTextRequestItemJSON: {
            ...
            required: ["@type", "freeText", "mustBeAccepted"],
            additionalProperties: false
        },
...
export const CompleteOutgoingRequestRequest: any = {
    ...
    definitions: {
        CompleteOutgoingRequestRequest: {
            ...
            required: ["receivedResponse", "messageId"],
            additionalProperties: false
        },
        ResponseJSON: {
            type: "object",
            ...
            required: ["@type", "items", "requestId", "result"],
            additionalProperties: false
        },
        ResponseResult: {
            type: "string",
        ...
        CreateAttributeAcceptResponseItemJSON: {
            ...
            required: ["@type", "attributeId", "result"],
            additionalProperties: false
        },
        ...
        ProposeAttributeAcceptResponseItemJSON: {
            ...
            required: ["@type", "attribute", "attributeId", "result"],
            additionalProperties: false
        },
        IdentityAttributeJSON: {
            type: "object",
        ...
        RegisterAttributeListenerAcceptResponseItemJSON: {
            ...
            required: ["@type", "listenerId", "result"],
            additionalProperties: false
        },
        ...
        ErrorResponseItemJSON: {
            ...
            required: ["@type", "code", "message", "result"],
            additionalProperties: false
        },
        MessageIdString: {
            type: "string",
...
export const CreateAndCompleteOutgoingRequestFromRelationshipTemplateResponseRequest: any = {
    ...
    definitions: {
        CreateAndCompleteOutgoingRequestFromRelationshipTemplateResponseRequest: {
            ...
            required: ["templateId", "responseSourceId", "response"],
            additionalProperties: false
        },
...
export const ReceivedIncomingRequestRequest: any = {
    ...
    definitions: {
        ReceivedIncomingRequestRequest: {
            ...
            required: ["receivedRequest", "requestSourceId"],
            additionalProperties: false
        },
        RequestJSON: {
            type: "object",
        ...
        CreateAndShareRelationshipAttributeRequest: {
            ...
            properties: {
                content: {
                    ...
                    required: ["value", "key", "confidentiality"],
                    additionalProperties: false
                },
                peer: {
                    $ref: "#/definitions/AddressString"
...
export const SucceedIdentityAttributeRequest: any = {
    ...
    definitions: {
        SucceedIdentityAttributeRequest: {
            ...
            required: ["predecessorId", "successorContent"],
            additionalProperties: false
        },
        "AttributeValues.Identity.Json": {
            anyOf: [
    ...
    definitions: {
        CreateSettingRequest: {
            ...
            properties: {
                ...
                scope: {
                    type: "string",
                    enum: ["Identity", "Device", "Relationship"]
                },
                succeedsAt: {
                    $ref: "#/definitions/ISO8601DateTimeString"
                },
...
export const RegisterPushNotificationTokenRequest: any = {
    ...
    definitions: {
        RegisterPushNotificationTokenRequest: {
            ...
            required: ["handle", "platform", "appId"],
            additionalProperties: false
        }
    }
};
...
export const CreateRelationshipChallengeRequest: any = {
    ...
    definitions: {
        CreateRelationshipChallengeRequest: {
            ...
            required: ["challengeType", "relationship"],
            additionalProperties: false
        },
...
export const ValidateChallengeRequest: any = {
    ...
    definitions: {
        ValidateChallengeRequest: {
            ...
            required: ["challengeString", "signature"],
            additionalProperties: false
        }
    }
};
...
export const UploadOwnFileRequest: any = {
    ...
    definitions: {
        UploadOwnFileRequest: {
            ...
            required: ["content", "filename", "mimetype", "expiresAt", "title"],
            additionalProperties: false
        },
        ISO8601DateTimeString: {
            type: "string",
...
export const UploadOwnFileValidatableRequest: any = {
    ...
    definitions: {
        UploadOwnFileValidatableRequest: {
            ...
            required: ["content", "expiresAt", "filename", "mimetype", "title"],
            additionalProperties: false
        },
        ISO8601DateTimeString: {
            type: "string",
...
export const AcceptRelationshipChangeRequest: any = {
    ...
    definitions: {
        AcceptRelationshipChangeRequest: {
            ...
            required: ["relationshipId", "changeId", "content"],
            additionalProperties: false
        },
        RelationshipIdString: {
            type: "string",
...
export const CreateOwnTokenRequest: any = {
    ...
    definitions: {
        CreateOwnTokenRequest: {
            ...
            required: ["content", "expiresAt", "ephemeral"],
            additionalProperties: false
        },
        ISO8601DateTimeString: {
            type: "string",
...
export const LoadPeerTokenViaSecretRequest: any = {
    ...
    definitions: {
        LoadPeerTokenViaSecretRequest: {
            ...
            required: ["id", "secretKey", "ephemeral"],
            additionalProperties: false
        },
        TokenIdString: {
            type: "string",
