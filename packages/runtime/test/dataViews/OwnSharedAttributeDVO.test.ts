import { AbstractIntegerJSON, AbstractStringJSON } from "@vermascht/content";
import { LocalAttributeDTO, RepositoryAttributeDVO } from "../../src";
import { ensureActiveRelationship, executeFullCreateAndShareIdentityAttributeFlow, RuntimeServiceProvider, TestRuntimeServices } from "../lib";
