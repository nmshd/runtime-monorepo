import { AcceptProposeAttributeRequestItemParametersJSON, DecideRequestItemGroupParametersJSON, LocalRequestStatus } from "@vermascht/consumption";
import { GivenName, IdentityAttribute, IdentityAttributeQuery, ProposeAttributeRequestItem, RelationshipAttributeConfidentiality, Surname } from "@vermascht/content";
