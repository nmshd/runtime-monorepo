import { AcceptReadAttributeRequestItemParametersWithNewAttributeJSON, LocalRequestStatus } from "@vermascht/consumption";
import { GivenNameJSON, IQLQuery, IdentityAttributeQuery, ReadAttributeRequestItem, SurnameJSON } from "@vermascht/content";
import {
    ConsumptionServices,
    DataViewExpander,
