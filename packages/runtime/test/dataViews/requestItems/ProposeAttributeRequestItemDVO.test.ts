import { AcceptProposeAttributeRequestItemParametersJSON, LocalRequestStatus } from "@vermascht/consumption";
import { AbstractStringJSON, GivenName, GivenNameJSON, IdentityAttribute, IdentityAttributeQuery, ProposeAttributeRequestItem, Surname, SurnameJSON } from "@vermascht/content";
