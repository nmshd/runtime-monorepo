...
import { ConsumptionController, LocalAttribute, LocalRequest, LocalRequestStatus } from "@vermascht/consumption";
import { DisplayName, IdentityAttribute } from "@vermascht/content";
