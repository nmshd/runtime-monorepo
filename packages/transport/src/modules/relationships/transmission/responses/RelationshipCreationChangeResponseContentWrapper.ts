...
export class RelationshipCreationChangeResponseContentWrapper
    extends CoreSerializable
    implements IRelationshipCreationChangeResponseContentWrapper
{
    @validate()
    @serialize()
    ...
    public static from(
        value: IRelationshipCreationChangeResponseContentWrapper
