...
export class RelationshipCreationChangeRequestContentWrapper
    extends CoreSerializable
    implements IRelationshipCreationChangeRequestContentWrapper
{
    @validate()
    @serialize()
    ...
    public static from(
        value: IRelationshipCreationChangeRequestContentWrapper
