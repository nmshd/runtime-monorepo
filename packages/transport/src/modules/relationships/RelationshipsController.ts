...
export class RelationshipsController extends TransportController {
    ...
    private async prepareRequest(
        ...
        const requestContent: RelationshipCreationChangeRequestContentWrapper =
            RelationshipCreationChangeRequestContentWrapper.from({
                content: content,
    ...
    private async decryptCreationChangeRequest(
        ...
        const requestContent = RelationshipCreationChangeRequestContentWrapper.deserialize(
    ...
    private async decryptCreationChangeResponse(
        ...
        const responseContent = RelationshipCreationChangeResponseContentWrapper.deserialize(
