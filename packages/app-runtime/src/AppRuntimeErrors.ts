...
class Startup {
    public bootstrapError(bootstrapError?: Error): UserfriendlyApplicationError {
        return new UserfriendlyApplicationError(
            "error.runtime.startup.BootstrapError",
            "There was an error while bootstrapping.",
            undefined,
            bootstrapError
        )
    }
    ...
    public bootstrapperNotInitialized(): UserfriendlyApplicationError {
        return new UserfriendlyApplicationError(
            "error.runtime.startup.BootstrapNotInitialized",
            "The given bootstrapper is not initialized."
        )
    }

    public uiBridgeAlreadyRegistered(): UserfriendlyApplicationError {
        return new UserfriendlyApplicationError(
            "error.appruntime.startup.uiBridgeAlreadyRegistered",
            "The ui bridge was already registered for this runtime instance."
        )
    }

    public wrongURL(): UserfriendlyApplicationError {
        return new UserfriendlyApplicationError(
            "error.appruntime.startup.WrongURL",
            "The given URL to start the App is in a wrong format."
        )
    }

    public wrongCode(): UserfriendlyApplicationError {
        return new UserfriendlyApplicationError(
            "error.appruntime.startup.WrongCode",
            "The given code is in a wrong format."
        )
    }
}
