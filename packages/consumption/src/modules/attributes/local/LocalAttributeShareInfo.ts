...
import { CoreAddress, CoreId, CoreSerializable, ICoreAddress, ICoreId } from "@vermascht/transport"
    ...
    protected static override postFrom<T extends Serializable>(value: T): T {
        ...
        if (typeof value.requestReference === "undefined" && typeof value.notificationReference === "undefined") {
            throw new ValidationError(
                ...
                `One of ${nameof<LocalAttributeShareInfo>(
                    (x) => x.requestReference
                )} or ${nameof<LocalAttributeShareInfo>((x) => x.notificationReference)} must be set.`
            )
        }
        ...
        if (typeof value.requestReference !== "undefined" && typeof value.notificationReference !== "undefined") {
            throw new ValidationError(
                LocalAttributeShareInfo.name,
                nameof<LocalAttributeShareInfo>((x) => x.requestReference),
                `Both of ${nameof<LocalAttributeShareInfo>(
                    (x) => x.requestReference
                )} or ${nameof<LocalAttributeShareInfo>((x) => x.notificationReference)} must not be set.`
            )
        }
