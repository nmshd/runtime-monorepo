...
export class OutgoingRequestsController extends ConsumptionBaseController {
    ...
    public async createAndCompleteFromRelationshipTemplateResponse(
        ...
        const isFromNewRelationship =
            parsedParams.responseSource instanceof RelationshipChange && parsedParams.responseSource.type === "Creation"

        const requestContent = isFromNewRelationship
