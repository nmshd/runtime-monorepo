...
import { AccountController, CoreAddress } from "@vermascht/transport"
...
export interface INotificationItemProcessor<TNotificationItem extends NotificationItem = NotificationItem> {
    checkPrerequisitesOfIncomingNotificationItem(
...
export abstract class AbstractNotificationItemProcessor<TNotificationItem extends NotificationItem = NotificationItem>
    implements INotificationItemProcessor<TNotificationItem>
{
