...
import { CoreError, CoreId } from "@vermascht/transport"
...
class Attributes {
    ...
    public successionPeerIsNotOwner() {
        return new CoreError(
            "error.consumption.attributes.successionPeerIsNotOwner",
...
class Requests {
    ...
    public invalidAcceptParameters(): ApplicationError {
        return new ApplicationError(
            ...
            "The RequestItem was answered with incorrect parameters."
        )
    }
