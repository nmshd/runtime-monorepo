...
export class ConsumptionController {
    ...
    public async init(
        ...
        notificationItemProcessorOverrides = new Map<
            NotificationItemConstructor,
            NotificationItemProcessorConstructor
        >()
        ...
        const requestItemProcessorRegistry = new RequestItemProcessorRegistry(
            this,
            this.getDefaultRequestItemProcessors()
        )
        ...
        const notificationItemProcessorRegistry = new NotificationItemProcessorRegistry(
            this,
            this.getDefaultNotificationItemProcessors()
        )
